  ...
  return (
    <div>
      <div className="text-center my-24">
        <h1 className="text-8xl font-medium">The <span className="text-nord10">WYSIWYG Markdown</span> Editor Framework</h1>
        <p className="text-2xl mt-6">A plugin driven framework to build <span className="text-nord10">WYSIWYG markdown</span> editor.</p>
